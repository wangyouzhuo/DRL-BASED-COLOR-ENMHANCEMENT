...
action_size = 12
import math
from train_encoder.action_set import *
...
def take_action(image_np, action_idx):
    ...
    if action_idx == 0:# 调整对比度
        return_np = contrast(image_np, 0.95)
    elif action_idx == 1:
        return_np = contrast(image_np, 1.05)
    # enhance color
    elif action_idx == 2:
        return_np = color_saturation(image_np, 0.95)
    elif action_idx == 3:
        return_np = color_saturation(image_np, 1.05)
    # color brightness
    elif action_idx == 4:
        return_np = brightness(image_np, 0.93)
    elif action_idx == 5:
        return_np = brightness(image_np, 1.07)
    # color temperature : http://stackoverflow.com/questions/11884544/setting-color-temperature-for-a-given-image-like-in-photoshop
        ...
        return_np = white_bal(image_np, r,g,b)
    elif action_idx == 7:
